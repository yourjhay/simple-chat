...
const Messages = () => {
    return (
        <div className="flex-grow h-full flex flex-col">
            <div className="w-full h-15 p-1 bg-purple-400 shadow-md rounded-xl rounded-bl-none rounded-br-none">
            ...
            <div className="w-full flex-grow bg-gray-100 my-2 p-2 overflow-y-auto">
                ...
                <div className="flex items-end w-3/4">
                    ...
                    <div className="p-3 bg-purple-300 mx-3 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
                        <div className="text-xs text-gray-100 hidden">
                            Rey Jhon A. Baqurin
                        </div>
                        <div className="text-gray-700">
                            gsegjsghjbdg bfb sbjbfsj fsksnf jsnfj snf nnfnsnfsnj
                ...
                <div className="flex justify-end">
                    <div className="flex items-end w-3/4 bg-purple-500 m-1 rounded-xl rounded-br-none sm:w-3/4 md:w-auto">
                        <div className="p-2">
                            <div className="text-gray-100">
                ...
                <div className="flex justify-end">
                    <div className="flex items-end w-3/4 bg-purple-500 m-1 rounded-xl rounded-br-none sm:w-3/4 max-w-xl md:w-auto">
                        <div className="p-2">
                            <div className="text-gray-100">
